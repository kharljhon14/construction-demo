...
const columns: Array<{
  ...
  { id: 'backlog', title: 'Backlog', tone: 'bg-slate-200 text-slate-600', helper: 'Queued work' },
  { id: 'in-progress', title: 'In Progress', tone: 'bg-blue-100 text-blue-700', helper: 'Teams executing' },
  { id: 'review', title: 'Review', tone: 'bg-amber-100 text-amber-700', helper: 'Awaiting sign-off' },
  { id: 'done', title: 'Done', tone: 'bg-emerald-100 text-emerald-700', helper: 'Closed tasks' },
]
...
export const AdminProjectsBoard = () => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Coordinate construction operations across sites."
        action={
